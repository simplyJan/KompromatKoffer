...
{
    public class MdLHessenModel : PageModel
    {
        ...
        public void OnGet(string sortOrder, string searchString, int? pageIndex, string currentFilter)
        {
            ...
            var list = Tweetinvi.TwitterList.GetExistingList(Config.Parameter.ListNameMdLHessen, Config.Parameter.ScreenNameMdLHessen);
